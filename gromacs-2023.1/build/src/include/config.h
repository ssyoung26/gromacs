...
/* Use double-batched FFT library for FFT on GPUs */
#define GMX_GPU_FFT_DBFFT 0
...
#define dbfft_VERSION ""

/* Target platform is x86 or x86_64 */
#define GMX_TARGET_X86 0
...
#define GMX_SIMD_STRING "ARM_NEON_ASIMD"
...
#define GMX_X86_GCC_INLINE_ASM 0
...
#define GMX_HAVE_CUDA_GRAPH_SUPPORT 0
...
// Define if hipSYCL should have AMD RDNA support (32-wide execution)
#define GMX_HIPSYCL_ENABLE_AMD_RDNA_SUPPORT 0
